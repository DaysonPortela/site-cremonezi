...
// Mudar Aqui o e-mail
$email_envio = 'contato@cremonezi.com'; // E-mail do site (ex: contato@seusite.com)
$email_pass = 'senha'; // Senha do e-mail

$site_name = 'Cremonezi'; // Nome do Site
$site_url = 'www.cremonezi.com'; // URL do Site

$host_smtp = 'mail.cremonezi.com'; // HOST SMTP Ex: smtp.domain.com.br
